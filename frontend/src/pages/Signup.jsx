...
const Signup = () => {
  ...
  const handleSignup = async (e) => {
    ...
    setLoading(true);
    try {
      const url = "https://mern-authentication-livid.vercel.app/api/auth/signup";
  ...
  return (
    <div style={styles.container}>
      {/* Multi-Color Glowing Background Ambient Blobs */}
      ...
      >
        ...
        <div style={styles.header}>
          ...
          <p style={styles.subtitle}>Join us to get started with your account</p>
        </div>
        ...
        <form onSubmit={handleSignup} style={styles.form}>
          ...
          <div style={styles.inputGroup}>
            <label style={{
              ...styles.label,
              color: focusedInput === 'name' ? '#f472b6' : '#94a3b8'
            }}>
              Full Name
            </label>
            <div style={styles.inputWrapper}>
              <User 
                ...
                style={{
                  ...styles.inputIcon,
                  color: focusedInput === 'name' ? '#f472b6' : '#64748b'
                }} 
              />
              <input
                ...
                style={{
                  ...styles.input,
                  borderColor: focusedInput === 'name' ? '#f472b6' : 'rgba(255,255,255,0.1)',
                  boxShadow: focusedInput === 'name' ? '0 0 15px rgba(244, 114, 182, 0.3)' : 'none'
                }}
              />
            </div>
          </div>
          ...
          >
            {loading ? (
              ...
              <>
                <span style={{ fontSize: '16px', fontWeight: 'bold' }}>Sign Up</span>
                <ArrowRight size={20} />
              </>
            )}
          </motion.button>
